      ...
      <section class="box-built">
        <div class="container-slide">
          <div class="slider-container">
            ...
            <div class="slider sizes-slider">
              <img class="img-dt" src="<?php print $base_url?>/shared/img/trangchu/cong-nghe-phun-xa.jpg" alt="Image">
              <img class="home-mb" src="<?php print $base_url?>/shared/img/trangchu/cong-nghe-phun-xa-mb.jpg" alt="Image">
            </div>
            <div class="box-btn">
